...
class ConversionViewController: UIViewController, UITextFieldDelegate { // conforming to delegate
    ...
    func textFieldDidBeginEditing(_ textField: UITextField) {
        celsiusLabel.text = "?"
        celsiusLabel.backgroundColor = UIColor(red: 60, green: 60, blue: 40, alpha: 1)
    }
